...
local Config =
{
    ProtectedName = "dumfucksrus", --What the protected name should be called.
    OtherPlayers = true, --If other players should also have protected names.
    OtherPlayersTemplate = "dumfucksrus", --Template for other players protected name (ex: "NamedProtect" will turn into "NameProtect1" for first player and so on)
